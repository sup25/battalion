...
import TempOuterCircle from "../../../components/TempCircleProgress/comps/OuterCircle";
import TempInnerCircle from "../../../components/TempCircleProgress/comps/InnerCircle";
import { FontsLoad } from "../../../utils/FontsLoad";

const TemperatureControlSlider = ({ navigation }) => {
  useEffect(() => {
    FontsLoad();
  }, []);
  const tost = useToast();
...
export default TemperatureControlSlider;
